...
layui.define("jquery", function (i) {
    "use strict";
    var a = layui.jquery, t = (layui.hint(), layui.device()), l = "elements", e = "layui-this", n = "layui-show",
        s = function () {
            this.config = {}
        };
    s.prototype.set = function (i) {
        ...
        var l = ".layui-tab-title", e = a(".layui-tab[lay-filter=" + i + "]"),
            n = e.find('.larry-title-box').children(l), s = e.children(".layui-tab-content");
        ...
        var l = ".layui-tab-title", e = a(".layui-tab[lay-filter=" + i + "]"),
            n = e.find('.larry-title-box').children(l), s = n.find('>li[lay-id="' + t + '"]');
        ...
        h = "layui-nav-more", y = "layui-anim layui-anim-upbit", f = {
            tabClick: function (i, t, s) {
                ...
                a(".layui-tab").each(function () {
                    var s = a(this), o = s.find('.larry-title-box').children(".layui-tab-title"),
